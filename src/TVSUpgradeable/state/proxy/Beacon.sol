...
/// @dev The beacon address is expected to have an `implementation()` function that returns the address of the implementation
...
library Beacon {
    ...
    bytes32 internal constant BEACON_SLOT = bytes32(uint256(keccak256("eip1967.proxy.beacon")) - 1); // from the EIP-1967 standard
